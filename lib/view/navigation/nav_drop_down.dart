...
class NavigDropDown extends StatefulWidget {
  @override
  State<NavigDropDown> createState() => _NavigDropDownState();
}
...
class _NavigDropDownState extends State<NavigDropDown> {
  ...
  Widget _backView(BuildContext context){
    SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle.dark.copyWith(
      statusBarColor: const Color.fromRGBO(39, 32, 48, 1.0), //or set color with: Color(0xFF0000FF)
    ));
...
class GuillotineMenu extends StatefulWidget {
  @override
  State<GuillotineMenu> createState() => _GuillotineMenuState();
}
...
class _GuillotineMenuState extends State<GuillotineMenu>
  ...
  final Color _menuBg = const Color.fromRGBO(76, 63, 92, 1.0);

  late Animation<double> _menuAnimation;

  late Animation<double> _toolbarTitleFadeAnimation;

  late AnimationController _guillotineMenuAnimationController;
...
*/
  ...
  void _getOffset() {
    final RenderObject offsetBox = _menuIconkey.currentContext!.findRenderObject()!;
