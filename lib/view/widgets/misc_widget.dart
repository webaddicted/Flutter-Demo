...
class _MiscWidgetState extends State<MiscWidget> {
  ...
  Future<void> _getAndroidDatePicker(BuildContext context) async {
...
//        }, currentTime: DateTime.now(), locale: LocaleType.en);
  ...
  Future<void> _getAndroidTimePicker(BuildContext context) async {
    ...
    setState(() {
      _time = '${pickedS?.hour} : ${pickedS?.minute} : ${pickedS?.period}';
    });
  }
    ...
    return Column(
      children: <Widget>[
        ...
        MaterialButton(
          ...
          textColor: Colors.white,
          color: Colors.blue,
          child: (const Text('Android Time Picker')),
        ),
        const SizedBox(height: 10),
        _cardView(),
        const SizedBox(height: 10),
