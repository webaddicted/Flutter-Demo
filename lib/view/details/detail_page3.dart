...
class Pointer extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    TextSpan spanMinLimit = new TextSpan(
        style: new TextStyle(color: Colors.black, fontSize: 3 * fontSize / 4),
        text: '$min');
    TextPainter minTp = new TextPainter(
      text: spanMinLimit,
    ...
    TextSpan spanMaxLimit = new TextSpan(
        style: new TextStyle(color: Colors.black, fontSize: 3 * fontSize / 4),
        text: '$max');
    TextPainter maxTp = new TextPainter(
        text: spanMaxLimit,
        textAlign: TextAlign.left,
        textDirection: TextDirection.ltr);
    maxTp.layout();
