...
class BothSideNavDrawerScreen extends StatefulWidget {
  @override
  _BothSideNavDrawerScreenState createState() =>
      _BothSideNavDrawerScreenState();
}

class _BothSideNavDrawerScreenState extends State<BothSideNavDrawerScreen> {
  BuildContext ctx;
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar:
          getAppBar(context, StringConst.NAVIGATION_DRAWER_TITLE),
      drawer: Drawer(
        child: _drawerView(),
      ),
      endDrawer: Drawer(
