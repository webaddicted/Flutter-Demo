...
//      "https://www.itl.cat/pngfile/big/10-100326_desktop-wallpaper-hd-full-screen-free-download-full.jpg";
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: getAppBarWithBackBtn(ctx:context, title:StringConst.DOWNLOAD_FILE_TITLE),
...
//      var dir = await getExternalStorageDirectory();
      ...
      Dio dio = Dio();
      printLog(msg: 'fileName   :  ' + fileName + '\n\n' + fileUrl.path);
