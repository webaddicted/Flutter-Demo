...
class ProfilePage8 extends StatefulWidget {
  @override
  State<ProfilePage8> createState() => _ProfilePage8State();
}
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ProfileHeader(
                avatar: const NetworkImage(ApiConstant.WEBADDICTED_IMG),
                coverImage: const NetworkImage(ApiConstant.WEBADDICTED_IMG),
                title: StringConst.DEEPAK_SHARMA,
                subtitle: StringConst.SE,
                actions: <Widget>[
                  MaterialButton(
                    color: Colors.white,
                      ...
                      ...ListTile.divideTiles(
                        ...
                        tiles: [
                          ...
                          const ListTile(
                            ...
                            title: Text("Email"),
                            subtitle: Text(StringConst.EMAIL),
                          ),
                          const ListTile(
                            leading: Icon(Icons.phone),
                            title: Text("Phone"),
                            subtitle: Text(StringConst.MOBILE_NO),
                          ),
                          const ListTile(
