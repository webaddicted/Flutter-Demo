...
List<TaskItem> apiCallItem = [
  ...
  TaskItem(title: 'Git Api Call', page: GitHttpsUsers(), codePreview: 'lib/view/api/git_https_users.dart'),
  TaskItem(title: 'DIO Api Call', page: ApiDioPage(), codePreview: 'lib/view/api/api_dio_page.dart'),
...
List<TaskItem> tabBarPageItem = [
  TaskItem(title: 'Tab Page1', page: TabPage1(), codePreview: 'lib/view/tabbar/tab_page1.dart'),
