...
class DrawerSlideController extends StatefulWidget {
  const DrawerSlideController({
    Key? key,
  ...
  @override
  _DrawerSlideControllerState createState() => _DrawerSlideControllerState();
}

class _DrawerSlideControllerState extends State<DrawerSlideController> with TickerProviderStateMixin {
