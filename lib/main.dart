...
//      darkTheme: ThemeData.dark(),
      theme: ThemeData(
          ...
          visualDensity: VisualDensity.adaptivePlatformDensity, colorScheme: ColorScheme.fromSwatch(primarySwatch: Colors.amber).copyWith(secondary: ColorConst.PRIME_COLOR)),
      home: SplashPage(),
    );
  }
}
